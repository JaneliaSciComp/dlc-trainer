...
def process_targets_folder(singularity_image_path, leaf_script_path, root_input_folder_path, targets_folder_path, root_output_folder_path, output_folder_path, n_submitted) :
    ...
    if os.path.exists(output_folder_path) :
        if os.path.isfile(output_folder_path) :
            ...
            if os.path.isdir(output_folder_path) :
                ...
                target_modification_time = os.path.getmtime(output_folder_path) 
                ...
                print("An object exists at output location %s, but it's neither a file nor a folder.  Not submitting a job." 
                      % output_folder_path)
                do_it = False
    else :
    ...
    lock_file_path = output_folder_path + ".lock"
    ...
    if do_it_for_reals :
        ...
        stdout_file_path = output_folder_path + '-training-stdout.txt'
        stderr_file_path = output_folder_path + '-training-stderr.txt'
        ...
        print("output_folder_path: %s" % output_folder_path)
        ...
        command_list = ['bsub', '-o', stdout_file_path, '-e', stderr_file_path, 
                        ...
                        'python3', leaf_script_path, targets_folder_path, lock_file_path, output_folder_path]
